...
- (id)initWithImageView:(UIImageView *)imageView
{
    ...
    if (self) {
        ...
        [self.croppingPath setLineDash:dashPattern count:2 phase:0];
...
+ (CGRect)scaleRespectAspectFromRect1:(CGRect)rect1 toRect2:(CGRect)rect2
{
    ...
    return CGRectMake(rect2.origin.x, y, scaledSize.width, scaledSize.height);
}
