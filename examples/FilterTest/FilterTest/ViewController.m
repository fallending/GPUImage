...
//        [beautifyFilter setBrightness:2 saturation:2];
        ...
        YUGPUImageHighPassSkinSmoothingFilter *beautyFilter = [[YUGPUImageHighPassSkinSmoothingFilter alloc] init];
        beautyFilter.amount = 0.7;
        [self.videoCamera addTarget:beautyFilter];
        [beautyFilter addTarget:self.filterView];
    }
}
