...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = color_with_rgb(40, 40, 40);
...
- (UIView *)topView {
    if (!topView) {
        ...
        view.backgroundColor = color_with_rgb(25, 25, 25);
...
- (UIView *)bottomScrollView {
    if (!bottomScrollView) {
        ...
        scrollView.backgroundColor = color_with_rgb(35, 35, 35);
        ...
        for (int index = 0; index < titles.count; index++)
        {
            ...
            HCPhotoEditCustomButton *btn = [[HCPhotoEditCustomButton alloc] initWithImage:image_named(name) highlightedImage:image_named(name2) title:titles[index] font:13 imageSize:0];
            btn.tag = index;
