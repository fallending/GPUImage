...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        buttonSize = 40;
        //顶点
        leftTop = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_button")];
        leftTop.frame = CGRectMake(0, 0, buttonSize, buttonSize);
        leftTop.contentMode = UIViewContentModeCenter;
        [self addSubview:leftTop];
        
        leftBottom = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_button")];
        ...
        rightBottom = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_button")];
        ...
        rightTop = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_button")];
        ...
        top = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_w")];
        ...
        left = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_h")];
        ...
        bottom = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_w")];
        ...
        right = [[UIImageView alloc] initWithImage:image_named(@"photo_crop_resize_h")];
