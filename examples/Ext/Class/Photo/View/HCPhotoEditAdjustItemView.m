...
-(UIView*)sliderConfigView:(NSInteger)index
{
    ...
    view.backgroundColor = color_with_rgb(40, 40, 40);
    ...
    bottomView.backgroundColor = color_with_rgb(40, 40, 40);
    [view addSubview:bottomView];
    
    HCPhotoEditCustomButton *btn1 = [[HCPhotoEditCustomButton alloc] initWithImage:image_named(@"photo_bottom_bar_cancel")  highlightedImage:image_named(@"photo_bottom_bar_cancel_light") title:nil font:0 imageSize:0];
    btn1.frame = CGRectMake(0, 0, bottomView.bounds.size.width/2.0 - 1, bottomView.bounds.size.height);
    [bottomView addSubview:btn1];
    
    HCPhotoEditCustomButton *btn2 = [[HCPhotoEditCustomButton alloc] initWithImage:image_named(@"photo_bottom_bar_ok")  highlightedImage:image_named(@"photo_bottom_bar_ok_light") title:nil font:0 imageSize:0];
