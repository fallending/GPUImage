...
-(void)didClickButtonAtIndex:(NSInteger)index  button:(HCPhotoEditCustomButton *)btn
{
    ...
    else if (index == 2)
    {
        if (btn.normalState) {
            ...
            [btn setImage:image_named(@"photo_crop_23_h") forState:UIControlStateSelected];
            [btn setTitle:@"2:3" forState:UIControlStateSelected];
            
        }else{
            view.proportion = 3.0/2.0;
            [btn setImage:image_named(@"photo_crop_32_h") forState:UIControlStateSelected];
    ...
    else if (index == 3)
    {
        if (btn.normalState) {
            ...
            [btn setImage:image_named(@"photo_crop_34_h") forState:UIControlStateSelected];
            [btn setTitle:@"3:4" forState:UIControlStateSelected];
        }else{
            view.proportion = 4.0/3.0;
            [btn setImage:image_named(@"photo_crop_43_h") forState:UIControlStateSelected];
    ...
    else if (index == 4)
    {
        if (btn.normalState) {
            ...
            [btn setImage:image_named(@"photo_crop_916_h") forState:UIControlStateSelected];
            [btn setTitle:@"9:16" forState:UIControlStateSelected];
        }else{
            view.proportion = 16.0/9.0;
            [btn setImage:image_named(@"photo_crop_169_h") forState:UIControlStateSelected];
    ...
    else if (index == 5)
    {
        ...
        if (btn.normalState) {
            ...
            [btn setImage:image_named(@"photo_crop_verticalgold_h") forState:UIControlStateSelected];
//            [btn setTitle:@"" forState:UIControlStateSelected];
        }else{
            view.proportion = 1.0/0.618;
            [btn setImage:image_named(@"photo_crop_horizontalgold_h") forState:UIControlStateSelected];
//            [btn setTitle:@"" forState:UIControlStateSelected];
        }
    }
