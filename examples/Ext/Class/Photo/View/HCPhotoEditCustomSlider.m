...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        [self setMinimumTrackTintColor:color_with_rgb(91, 98, 105)];
        [self setMaximumTrackTintColor:color_with_rgb(91, 98, 105)];
        [self setThumbImage:image_named(@"photo_slider_step_button") forState:UIControlStateHighlighted];
        [self setThumbImage:image_named(@"photo_slider_step_button") forState:UIControlStateNormal];
...
-(void)setItemTitles:(NSArray*)titles
{
    ...
    for (int index = 0; index < titles.count; index++)
    {
        ...
        label.textColor = color_with_rgb(91, 98, 105);
...
-(void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    lastSelectLabel.textColor = color_with_rgb(91, 98, 105);
    lastSelectLabel = titleLabelsArray[index];
    lastSelectLabel.textColor = color_with_rgb(250, 223, 84);
}
